...
const NotificationScreen = ({navigation}) => {
  ...
  return (
    <View style={{flex: 1, paddingTop: insets?.top, backgroundColor: '#fff'}}>
      {/* <Scroll> */}
      <View style={{borderBottomWidth: 1, borderColor: '#E2E4E8'}}>
        <View
          style={{
            flexDirection: 'row',
            alignItems: 'center',
          ...
          renderItem={({item}) => (
            <TouchableOpacity style={styles.user}>
              <View style={{flex: 1, gap: 3}}>
                <TextTag fontSize={9} fontFamily='semi-bold'>Ayodeji Emmanuel started following you</TextTag>
                <View style={{flexDirection: 'row', gap: 10, alignItems: 'center'}}>
                  <View style={{flexDirection: 'row', gap: 5, alignItems: 'center'}}>
                    <Ionicons name='calendar-outline' size={12} color={colors.gray100} />
                    <TextTag fontSize={8} fontFamily='regular' color={colors?.gray100}>23rd Aug 2023</TextTag>
                  </View>
                  <TextTag fontSize={8} fontFamily='regular' color={colors?.gray100}>10:24 AM</TextTag>
                </View>
              </View>
